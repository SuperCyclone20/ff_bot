...
if __name__ == '__main__':
    ...
    trophies:                           tuesday morning at 7:15pm.
    ...
    sched.add_job(bot_main, 'cron', ['get_final'], id='final', day_of_week='tue', hour=19, minute=15, start_date=ff_start_date, end_date=ff_end_date, timezone=myTimezone, replace_existing=True)
